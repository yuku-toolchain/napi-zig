...
- [Quick start](/guide/quick-start) scaffolds a working addon in one command.
- [Manual setup](/guide/manual-setup) wires it up step by step.
- [Functions](/guide/functions) covers the core concept that explains most of the library.
